 ...
 * trn_cell_extension_field_t in 'inp'
 */
uint64_t trn_cell_extension_field_get_field_len(const trn_cell_extension_field_t *inp);
/** Set the value of the field_len field of the
 * trn_cell_extension_field_t in 'inp' to 'val'. Return 0 on success;
 * return -1 and set the error code on 'inp' on failure.
 */
int trn_cell_extension_field_set_field_len(trn_cell_extension_field_t *inp, uint64_t val);
